        ...
        <div className="mt-12 grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
          {projects.map((p, i) => (
            <Reveal key={i} delay={i * 0.08}>
              <article className="group relative rounded-2xl border border-blue-500/20 bg-slate-900/60 p-6 transition-transform duration-300 hover:-translate-y-1 hover:shadow-[0_0_30px_rgba(59,130,246,0.25)]">
